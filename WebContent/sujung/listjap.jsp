<%@ page language="java" contentType="text/html; charset=utf-8"
    ...
    List<BoardVO> lsjap = dao.selectjap();
    pageContext.setAttribute("lsjap",lsjap);
    %>
...
<body>
    ...
    <div class="container">
        <div class="list_card">
        <c:forEach var="first_board" items="${lsjap}">
            ...
            <%} 
              ...
              <a href="heartjap.jsp?num=${first_board.num}"> <i class="far fa-heart"> 좋아요 : ${first_board.heart}</i></a>
             <%}%>
