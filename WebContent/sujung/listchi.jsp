<%@ page language="java" contentType="text/html; charset=utf-8"
    ...
    List<BoardVO> lschi = dao.selectchi();
    pageContext.setAttribute("lschi",lschi);
    %>
...
<body>
    ...
    <div class="container">
        <div class="list_card">
        <c:forEach var="first_board" items="${lschi}">
            ...
            <%} 
              ...
              <a href="heartchi.jsp?num=${first_board.num}"> <i class="far fa-heart"> 좋아요 : ${first_board.heart}</i></a>
             <%}%>
