<%@ page language="java" contentType="text/html; charset=utf-8"
    ...
    List<BoardVO> lskor = dao.selectcafe();
    pageContext.setAttribute("lskor",lskor);
    %>
...
<body>
    ...
    <div class="container">
        <div class="list_card">
        <c:forEach var="first_board" items="${lskor}">
            ...
            <%} 
              ...
              <a href="heartcafe.jsp?num=${first_board.num}"> <i class="far fa-heart"> 좋아요 : ${first_board.heart}</i></a>
             <%}%>
